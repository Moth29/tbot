...
def get_langflow_response(message):
    try:
        # Существующий код запроса к Langflow остается без изменений
        
        # Расширенный список путей для поиска сообщения
        ...
        # Если ничего не нашли, используем глубокий поиск
